#c:\Python27\python.exe "Version 0.2.8.py"
# -*- coding: utf-8 -*-
...
def updates():
    ...
    print '3. Show all items in bag. Some items are missing.'
    print '4. Add a save function. EST: Version 0.3.0'
...
if password=="123456":
    ...
    def collisseum():
        ...
        print
        try:
            health=int(raw_input('How much health does the enemy have: '))
        except ValueError:
            value_error()
        current_enemy=raw_input('What will the enemies name be: ')
        clear()
        start_attack()
        custom_attack=False
        move_on=raw_input('Hit enter to exit: ')
    ...
    if dev==False:
        ...
        if name=='skip':
            ...
            check = raw_input('To skip hit enter: ')
            if check == "":
                skip=True
                bag_open=True
                menu_open=True
    ...
    if start==True:
        ...
        while loop == True:
            ...
            while loop == True:
                ...
                clear()
                if check == "load beta_vars" or check == "load_beta_vars" or check == "load beta vars":
                    try:
                        if beta_var==True:
                            try:
                                from beta_vars import *
                        ...
                        pass
                if check == "practice" or check == "test" or check == "work out" or check == "work_out":
                    ...
                    if dev==False:
                        non_function()
                if check == "exit dev mode" or check == "exit_dev_mode" or check == "edm":
                    choice = raw_input('Are you sure: ').lower()
                    if choice == "yes" or choice == "y":
                        print 'System: Settings have been altered.'
                        dev=False
                    else:
                        print 'System: Settings have not been altered.'
                if check == "stats" or check == "stat" or check == "statistics":
                    stats()
                if check == "clear cache" or check == "clear_cache":
                    clear_cache()
                if check == "sleep" or check == "tired" or check == "sleeping" or check == "rest":
                    if dev==False:
                        non_function()
                    if dev==True:
                        print 'Sleeping...'
                        ...
                        move_on=raw_input('Hit enter to exit: ')
                if check == "load settings.dev" or check == "load_settings.dev":
                    if dev==True:
                        clear()
                        try:
                            os.rename('settings.dev','settings.py')
                ...
                if check == "battle":
                    ...
                    if guts_and_glory==False and dev==False:
                        non_function()
                if check == "shop" or check == "trade" or check == "sell":
                    shop()
                    check=''
                if check == "damage":
                    item_damage()
                    move_on=raw_input('Hit enter to exit: ')
                    check=''
                if check == "settings" or check == "setting":
                    settings()
                    check=''
                    clear()
                if check == "chapters" or check == "chapter":
                ...
                if check == "start":
                    ...
                    if story_part6==True or repeat_chapters==True:
                        ...
                        move_on=raw_input('Hit enter to start battle: ')
                        clear()
                        start_attack()
                        if victory_status==True:
                            story_part6=False
