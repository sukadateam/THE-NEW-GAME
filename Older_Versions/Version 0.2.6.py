...
def next_update():
    ...
    print '5. Grammer checks on notes need to be done.'
    print ''
...
if password=="123456":
    ...
    def notes(number):
        ...
        if number==6:
            ...
            print 'You: Sir! Sir! Looks like we are own our own.'
        if number==7:
            print 'I finally created a device to be able to help us cordnate these tunnels. This will help us get out.'
        if number==8:
            print 'I\'m experiencing problems with the device. It won\'t turn on anymore. It seems to have lost charge. If i can find anyway of charging it then I could possibly escape.'
        if number==9:
        ...
        if number==10:
            print 'I have been in here for 100 days. There is no way out. Please, anyone who finds these notes come save me. Again my cordnittes are 52, 61, 30.'
    def trade():
