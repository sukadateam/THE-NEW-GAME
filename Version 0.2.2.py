...
def updates():
    ...
    print '7. Add spears as a weapon in game.'
    print '8. Add a save function. EST: Version 0.2.5 or Version 0.3.0'
...
if password=="123456":
    ...
    def shop():
        global coal_sell, wires_sell, sticks_sell, spears_sell, torches_sell, computer_chips_sell, good_batteries_sell, bad_batteries_sell, throwing_rocks_sell, money, coal, wires, sticks, spears, torches, good_batteries, bad_batteries, computer_chips, throwing_rocks
    ...
    def count():
        ...
        clear()
    def open_bag():
        global spears, spears_use, one_time, victory_status, attack, health, bag_open, good_batteries, bad_batteries, torches, battery, throwing_rocks, battery_charger, computer_chips, wires, sticks, coal, throwing_rocks_use, flashlight_use, torch_use
        if bag_open == False:
            bag_open=True
        ...
        if torch_use==False and flashlight_use==False:
