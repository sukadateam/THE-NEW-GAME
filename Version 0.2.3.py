...
run_off=True
error_message=True
if all_chapters_unlocked==True or dev==True:
    begin=True
    story_part1=True
    story_part2=True
    story_part3=True
    ...
    story_part7=True
    story_part8=True
if all_chapters_unlocked==False and dev==False:
    begin=False
    story_part1=False
    story_part2=False
    story_part3=False
...
def updates():
    ...
    print '6. Show all items in bag. Some items are missing.'
    print '7. Add a save function. EST: Version 0.2.5 or Version 0.3.0'
    skip = raw_input('Hit enter to exit:')
def next_update():
    print 'Things to do for update Version 0.2.4:'
    print '1. Add more text scense when user uses a torch or a flashlight in battle.'
    print '2. Add 1 more text scene when user uses a spear in battle.'
    print '3. Add another chapter to the story.'
    print ''
...
if password=="123456":
    ...
    def shop():
        global battery_charger, coal_sell, wires_sell, sticks_sell, spears_sell, torches_sell, computer_chips_sell, good_batteries_sell, bad_batteries_sell, throwing_rocks_sell, money, coal, wires, sticks, spears, torches, good_batteries, bad_batteries, computer_chips, throwing_rocks
        ...
        clear()
    def item_damage():
        global throwing_rocks_damage, spears_damage
        print 'Damage per item:'
    ...
    def start_attack():
        global health, attack, throwing_rocks, victory_status, wires, torches, one_time
    ...
    def chapters():
        ...
        print 'Chapter 7:',str(story_part7),' -- Not yet implemented'
    ...
    def count():
        ...
        clear()
    def open_bag():
        global total_wins, spears, spears_use, one_time, victory_status, attack, health, bag_open, good_batteries, bad_batteries, torches, battery, throwing_rocks, battery_charger, computer_chips, wires, sticks, coal, throwing_rocks_use, flashlight_use, torch_use
        if bag_open == False:
            bag_open=True
    ...
    if start==True:
        ...
        while loop == True:
            ...
            while loop == True:
                ...
                print '(settings) (damage_info)'
                print '(shop) (battle_arena)'
                check = raw_input('Choose an option: ').lower()
                clear()
                if check == "edit_chapters":
                    if dev==True:
                        edit_chapters()
                    if dev==False:
                ...
                if check == "save":
                    non_function()
                if check == "battle arena" or check == "battle_arena":
                    non_function()
                if check == "shop":
                    shop()
                    check=''
                if check == "damage_info" or check == "damage info":
                    item_damage()
                    check=''
                if check == "setting" or check == "settings":
                    settings()
