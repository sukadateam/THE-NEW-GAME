...
password='123456'
if password=="123456":
    enemy=['Goblin','Karen','Bat','Donald T.']
    current_enemy=''
    ...
    def shop():
        global i_have_the_power, battery_charger, coal_sell, wires_sell, sticks_sell, spears_sell, torches_sell, computer_chips_sell, good_batteries_sell, bad_batteries_sell, throwing_rocks_sell, money, coal, wires, sticks, spears, torches, good_batteries, bad_batteries, computer_chips, throwing_rocks
    ...
    def start_attack():
        global health, attack, throwing_rocks, victory_status, wires, torches, one_time, enemy, current_enemy, battery
        count=len(enemy)
